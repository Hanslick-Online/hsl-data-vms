<xsl:stylesheet 
    ...
    <xsl:template match="/">
        ...
        <rdf:RDF xmlns:acdh="https://vocabs.acdh.oeaw.ac.at/schema#">
            ...
            <xsl:for-each select=".//acdh:Collection[@rdf:about='https://id.acdh.oeaw.ac.at/hanslick-vms-reviews/editions']">
                <acdh:Collection>
                    ...
                    <acdh:hasCreator rdf:resource="https://id.acdh.oeaw.ac.at/mwilfing-albrecht"/>
            ...
            <xsl:for-each select=".//acdh:Collection[@rdf:about='https://id.acdh.oeaw.ac.at/hanslick-vms-reviews/facsimiles']">
                <acdh:Collection>
                    <xsl:attribute name="rdf:about"><xsl:value-of select="@rdf:about"/></xsl:attribute>
                    <acdh:hasCreator rdf:resource="https://id.acdh.oeaw.ac.at/awilfing"/>
                    <acdh:hasCreator rdf:resource="https://id.acdh.oeaw.ac.at/mwilfing-albrecht"/>
            ...
            <xsl:for-each select="collection('../data/editions')//tei:TEI">
                ...
                <xsl:if test=".//tei:facsimile and @xml:id != 't__02_VMS_1858_TEI_AW_26-01-21-TEI-P5.xml' and @xml:id != 't__03_VMS_1865_TEI_AW_26-01-21-TEI-P5.xml'">
                    <acdh:Collection>
                        ...
                        <acdh:hasDigitisingAgent rdf:resource="https://id.acdh.oeaw.ac.at/awilfing"/>
            ...
            <acdh:Resource rdf:about="https://id.acdh.oeaw.ac.at/hanslick-vms/logo_font_blau.svg">
                ...
                <acdh:hasCurator rdf:resource="https://id.acdh.oeaw.ac.at/delsner"/>
